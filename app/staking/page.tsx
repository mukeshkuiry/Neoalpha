    ...
    <div className="px-60 text-center">
      <div className="flex flex-col items-center justify-center gap-4 mt-8">
        <h1 className="text-4xl">
          Earn{" "}
          <span className="bg-gray-800 text-white px-2 rounded-xl">
            rewards
          </span>{" "}
          with ZKLiquid
        </h1>
      ...
      <div className="p-6 rounded-2xl bg-white flex justify-between items-center mt-8 text-start">
        ...
        <div
          onClick={showModal}
          className="flex items-center bg-gray-400 hover:bg-gray-500 hover:scale-105 transition-all cursor-pointer h-fit text-black text-sm pr-1.5 p-1 pl-3 rounded-full"
        >
      ...
      <div className="p-6 rounded-2xl bg-white flex justify-between items-center mt-8 text-start">
        <div className="flex items-center gap-6">
          ...
          <div>
            <p className="text-sm text-gray-600">ZKLiquid staking APY</p>
            <h1 className="text-2xl mt-1">19.5%</h1>
          </div>
          <div>
            <p className="text-sm text-gray-600">ZKLiquid price</p>
