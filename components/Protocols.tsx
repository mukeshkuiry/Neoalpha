...
export default function Protocols() {
  return (
    <div className="flex flex-col items-center mt-20">
      <h1 className="text-3xl m-8">Protocols built on top of ZKLiquid</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-gray-900 rounded-xl flex p-4 items-center mt-8 md:mt-0">
          ...
          <div>
            ...
            <p className="text-gray-300">(ZKLiquid) Aggregating yield and diversifying risk across multiple chains</p>
          </div>
        </div>
      </div>
    </div>
